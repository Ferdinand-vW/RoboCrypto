...
template <OType OT> class OrdSpec {};

/*********************Concrete Order Types**********************/
template <> class OrdSpec<OType::Market> {
  public:
    BaseOrQuote m_boq;
...
template <> class OrdSpec<OType::Limit> {
  public:
...
template <> class OrdSpec<OType::StopLoss> {
  public:
    Price m_stop;
...
template <> class OrdSpec<OType::StopLossLimit> {
  public:
    TimeInForce m_time_in_force;
    Price m_limit;
    Price m_stop;
...
template <> class OrdSpec<OType::TakeProfit> {
  public:
    Price m_take;
...
template <> class OrdSpec<OType::TakeProfitLimit> {
  public:
    TimeInForce m_time_in_force;
    Price m_limit;
    Price m_take;
...
template <> class OrdSpec<OType::LimitMaker> {
  public:
    Price m_limit;
